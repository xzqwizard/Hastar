...
public class MySwipeableItemAdapter
    ...
    public MySwipeableItemAdapter(Context inContext, List<Record> records, final OnItemDeleteListener onItemDeleteListener, OnItemClickListener onItemClickListener) {
        mContext = inContext;
