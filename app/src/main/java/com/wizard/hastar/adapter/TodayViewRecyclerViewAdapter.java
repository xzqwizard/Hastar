    ...
    public TodayViewRecyclerViewAdapter(int start, int end, Context context, int position) {
        ...
        if (!IS_EMPTY) {
            ...
            for (int i = 0; i < size; i++) {
                Record coCoinRecord = allData.get(i);
...
// set the listener of the show all button//////////////////////////////////////////////////////////
    ...
    public static class viewHolder extends RecyclerView.ViewHolder {
        ...
        viewHolder(View view) {
            ...
            dateBottom = (TextView) view.findViewById(R.id.date_bottom);
            expanseSum = (TextView) view.findViewById(R.id.expanse);
            emptyTip = (TextView) view.findViewById(R.id.empty_tip);
            pie = (PieChartView) view.findViewById(R.id.chart_pie);
            histogram = (ColumnChartView) view.findViewById(R.id.histogram);
            iconLeft = (MaterialIconView) view.findViewById(R.id.icon_left);
            iconRight = (MaterialIconView) view.findViewById(R.id.icon_right);
            histogram_icon_left = (MaterialIconView) view.findViewById(R.id.histogram_icon_left);
            histogram_icon_right = (MaterialIconView) view.findViewById(R.id.histogram_icon_right);
            reset = (MaterialIconView) view.findViewById(R.id.icon_reset);
            all = (MaterialIconView) view.findViewById(R.id.all);
            tagImage = (ImageView) view.findViewById(R.id.tag_image);
            money = (TextView) view.findViewById(R.id.money);
            cell_date = (TextView) view.findViewById(R.id.cell_date);
            remark = (TextView) view.findViewById(R.id.remark);
            index = (TextView) view.findViewById(R.id.index);
            layout = (MaterialRippleLayout) view.findViewById(R.id.material_ripple_layout);
    ...
    private class mActionClickListenerForPie implements ActionClickListener {
        ...
        public void onActionClicked(Snackbar snackbar) {
            List<Record> shownCoCoinRecords = Expanse.get(tagId);
            ((FragmentActivity) mContext).getSupportFragmentManager()
                    .beginTransaction()
                    .add(new RecordCheckDialogFragment(
