...
import com.wizard.hastar.ui.money_manager.db.DBHelper;
...
public class HaStarUtil {
    ...
    public static Record backupCoCoinRecord;
...
//            R.drawable.sum_header_pie
    ...
    public static void init(Context context) {
        ...
        MY_BLUE = ContextCompat.getColor(MyApplication.getAppContext(), R.color.my_blue);
    }

    public static Typeface GetTypeface() {
        if (typefaceLatoLight == null) init(MyApplication.getAppContext());
    ...
    public static String GetAxisDateName(int type, int position) {
        switch (type) {
            ...
            case Calendar.DAY_OF_WEEK:
                if (WEEK_START_WITH_SUNDAY) return MyApplication.getAppContext().getResources()
                        .getString(WEEKDAY_SHORT_START_ON_SUNDAY[position + 1]);
                else return MyApplication.getAppContext().getResources()
    ...
    public static int GetTagColor(int tag) {
        return ContextCompat.getColor(MyApplication.getAppContext(), TAG_COLOR[tag + 3]);
    }

    public static Drawable GetTagDrawable(int tagId) {
        return ContextCompat.getDrawable(
                MyApplication.getAppContext(), TAG_DRAWABLE[tagId + 3]);
    }
    ...
    public static Drawable GetTagIconDrawable(int tagId) {
        return ContextCompat.getDrawable(
                MyApplication.getAppContext(), TAG_ICON[tagId + 2]);
    }
...
//        if (file.exists()) file.delete();
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = MyApplication.getAppContext()
                .getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = MyApplication.getAppContext()
